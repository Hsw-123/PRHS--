...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public Long saveOrderInfo(OrderInfoForm orderInfoForm) {
        ...
        redisTemplate.opsForValue().set(RedisConstant.ORDER_ACCEPT_MARK + Long.toString(orderInfo.getId()),
    ...
    public Boolean robNewOrder(Long driverId, Long orderId) {
        ...
        if(!redisTemplate.hasKey(RedisConstant.ORDER_ACCEPT_MARK + Long.toString(orderId))) {
            //抢单失败
        ...
        try {
            ...
            if(flag) {
                ...
                //删除抢单标识
                redisTemplate.delete(RedisConstant.ORDER_ACCEPT_MARK+ Long.toString(orderId));
            }
        }catch (Exception e) {
            //抢单失败
            throw new GuiguException(ResultCodeEnum.COB_NEW_ORDER_FAIL);
    ...
    //获取乘客订单分页列表
    @Override
    public PageVo findCustomerOrderPage(Page<OrderListVo> pageParam, Long customerId) {
